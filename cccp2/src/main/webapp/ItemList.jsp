...
<header>
    <nav class="navbar navbar-expand-md navbar-dark">
        <div class="container">
            ...
            <div class="row">
                <div class="container">
                    <h3 class="text-center" style="font-weight: bold; font-size: 28px; margin-bottom: 20px;">ITEM LIST</h3>
                    <hr>
                    <div class="container text-left">

                        <a href="<%=request.getContextPath()%>/ServletShowFormItem" class="btn btn-success">Add New Item</a>
                    </div>
                    <br>
